package com.alipay.api.trade.config;
...
public class Configs {
    ...
    private static String ali_rdx_public_key;       // RSA公钥，仅用于验证开发者网关
    ...
    public synchronized static void init(String filePath) {
        ...
        ali_rdx_public_key = configs.getString("public_key");
    ...
    public static String description() {
        ...
        sb.append(", 商户RSA公钥: ").append(getKeyDescription(ali_rdx_public_key)).append("\n");
    ...
    public static void setPublicKey(String publicKey) {
        Configs.ali_rdx_public_key = publicKey;
    }
