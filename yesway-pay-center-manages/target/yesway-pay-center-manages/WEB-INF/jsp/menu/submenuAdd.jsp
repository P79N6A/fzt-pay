...
<body>
	...
	<section class="content">
		<div class="box box-solid box-default">
			...
			<div class="box-body">
				<form class="form-horizontal" role="form" id="menuForm" action="<%=request.getContextPath()%>/menu/saveSubMenu">
					...
					<div class="form-group">
						...
						<div class="input-group col-sm-5">
							<input type="text" class="form-control" id="menuName" name="menuName"  placeholder="请输入菜单名称" value="" >
						</div>
					</div>
					<div class="form-group">
						<label for="group" class="col-sm-2 control-label"><font color="red">*</font>二级菜单路径</label>
						<div class="input-group col-sm-5">
							<input type="text" class="form-control" id="parentMenuUrl"  name="parentMenuUrl"  placeholder="请输入菜单路径" value=""	>
						</div>
					</div>
					<div class="form-group">
						<label for="group" class="col-sm-2 control-label"><font color="red">*</font>父菜单名称</label>
						<div class="input-group col-sm-5">
							<input type="text" class="form-control" id="parentId"  name="parentId"  placeholder="请输入父菜单名称" readonly="readonly" 	value="${menu.menuName}">
						</div>
					</div>
