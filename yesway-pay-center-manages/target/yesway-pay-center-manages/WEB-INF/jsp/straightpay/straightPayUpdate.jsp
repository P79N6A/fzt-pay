...
<body>
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="#"><i class="fa"></i>二级商户修改</a></li>
		...
		<div class="box box-solid box-default">
			...
			<div class="box-body" id="oneTag">
				...
				<div class="form-group">
					...
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="name" name="name" placeholder="请输入商户全称" value="${bizContent.name}">
					</div>
				</div>
				<div class="form-group">
					<label for="alias_name" class="col-sm-2 control-label"><font color="red">*</font>商户简称</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="alias_name" name="alias_name" placeholder="请输入商户简称" value="${bizContent.alias_name}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="cert_no" name="cert_no" placeholder="请输入商户证件编号" value="${bizContent.cert_no}">
					</div>
				</div>
				<div class="form-group">
					<label for="mcc" class="col-sm-2 control-label"><font color="red">*</font>商户类别码</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="mcc" name="mcc" placeholder="请输入商户类别码" value="${bizContent.mcc}">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="sign_time_with_isv" name="sign_time_with_isv" placeholder="" value="${bizContent.sign_time_with_isv}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="legal_name" name="legal_name" placeholder="" value="${bizContent.legal_name}">
					</div>
				</div>
				<div class="form-group">
					<label for="legal_cert_no" class="col-sm-2 control-label"><font color="red">*</font>法人身份证号</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="legal_cert_no" name="legal_cert_no" placeholder="" value="${bizContent.legal_cert_no}">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="addressInfo.address" name="addressInfo.address" placeholder="" value="${addressInfo.address}">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="service_phone" name="service_phone" placeholder="" value="${bizContent.service_phone}">
					</div>
				</div>
			...
			<div class="box-body" id="twoTage">
				...
				<div class="form-group">
					...
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="account_holder_name" name="account_holder_name" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="account_branch_name" class="col-sm-2 control-label"><font color="red">*</font>开户支行</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="account_branch_name" name="account_branch_name" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="account_no" class="col-sm-2 control-label"><font color="red">*</font>账号</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="account_no" name="account_no" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="account_inst_name" class="col-sm-2 control-label"><font color="red">*</font>开户总行</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="account_inst_name" name="account_inst_name" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="account_inst_id" class="col-sm-2 control-label"><font color="red">*</font>开户行缩写</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="account_inst_id" name="account_inst_id" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="alipay_logon_id" name="alipay_logon_id" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="title" name="title" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="tax_no" class="col-sm-2 control-label"><font color="red">*</font>纳税人识别号</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="tax_no" name="tax_no" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="tax_payer_valid" class="col-sm-2 control-label"><font color="red">*</font>纳税人资格认定</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="tax_payer_valid" name="tax_payer_valid" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="merchantInvoiceInfo.address" class="col-sm-2 control-label"><font color="red">*</font>开票地址</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="merchantInvoiceInfo.address" name="merchantInvoiceInfo.address" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="telephone" class="col-sm-2 control-label"><font color="red">*</font>开票电话</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="telephone" name="telephone" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="mail_name" class="col-sm-2 control-label"><font color="red">*</font>收件人名称</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="mail_name" name="mail_name" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="address" class="col-sm-2 control-label"><font color="red">*</font>收件人地址</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="address" name="address" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="mail_telephone" class="col-sm-2 control-label"><font color="red">*</font>收件人电话</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="mail_telephone" name="mail_telephone" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="col-sm-offset-2 col-sm-10">
			...
			<div class="box-body" id="threeTag">
				...
				<div class="form-group">
					...
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="contactInfo.name" name="contactInfo.name" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="mobile" class="col-sm-2 control-label"><font color="red">*</font>联系人手机</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="mobile" name="mobile" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="phone" class="col-sm-2 control-label"><font color="red">*</font>联系人公司座机</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="phone" name="phone" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="email" class="col-sm-2 control-label"><font color="red">*</font>联系人邮箱</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="email" name="email" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="form-group">
					<label for="id_card_no" class="col-sm-2 control-label"><font color="red">*</font>联系人身份证号</label>
					<div class="input-group col-sm-5">
						<input type="text" class="form-control" id="id_card_no" name="id_card_no" placeholder="" value="${oem.oemName}">
					</div>
				</div>
				<div class="col-sm-offset-2 col-sm-10">
