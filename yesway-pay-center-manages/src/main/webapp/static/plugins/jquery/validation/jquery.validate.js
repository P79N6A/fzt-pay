...
$.extend( $.validator, {
	...
	prototype: {
		...
		init: function() {
			...
			// Add aria-required to any Static/Data/Class required fields before
			// first validation
			// Screen readers require this attribute to be present before the
		...
		// return the generic message if present and no method specific message
		// is present
		...
		showLabel: function( element, message ) {
			...
			if ( error.length ) {
				...
				if ( error.is( "label" ) ) {
					...
					// If this element is grouped, then assign to all elements
					// in the same group
