...
public class RSAUtils {
	 ...
	 * @throws Exception
	 */
	public static String encryptByPublicKey(String data,String yeswayPublicKey) throws Exception {
		byte[] dataByte = data.getBytes();
		byte[] keyBytes = Base64Utils.decode(yeswayPublicKey);//PUBLIC_KEY
