...
//import com.ailk.mvno.crm.api.base.vo.RequestHeader;

public class ConfigUtil {

	private static Properties mConfig;
	private static Log log = LogFactory.getLog(ConfigUtil.class);
	private static String default_config_1 = "/config/config.rabbitmq.properties";
    ...
    public static RequestHeader createRequestHeader() {
        ...
        requestHeader.setApplyChlId("J00G");
        requestHeader.setOperId(1L);
        requestHeader.setFromType("2");
        requestHeader.setApplyChlId("0");
        requestHeader.setProvinceCode("11");
