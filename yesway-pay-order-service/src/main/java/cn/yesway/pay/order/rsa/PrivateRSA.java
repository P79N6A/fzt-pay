...
public class PrivateRSA {
	//private static String strPriKey = "RSAPrivateKey";
	private static String strPriKey="MIICdwIBADANBgkqhkiG9w0BAQEFAASCAmEwggJdAgEAAoGBAJjlW8RNz7z/HRFOYyBHXoe2M/SO"
...
+"XcwR4QK1g5g="; //= FileConfig.private_key;
	...
	private static RSAPrivateKey privateKey = getPrivateKey(strPriKey);
